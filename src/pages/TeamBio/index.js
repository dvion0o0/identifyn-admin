...
import Shapes from '../../components/modals/addMemberModal/newMemberModal/photoShapeModal/Shapes/shapes'
const Index = () => {
  ...
  return (
    <Layout>
                          ...
                          {(provided) => (
                            ...
                            >
                              <div className="left-container">
                                ...
                                />
                                  {member.shapeType ? <Shapes key={member.id} shapeType={index + 1} style={{ clipPath: `url(#svgPath-${index + 1})`, backgroundImage: `url(${member.img})` }} selectedPhoto={member.img} smaller />
      ...
      {openAddMemberModal && <AddMemberModal setOpenAddMemberModal={setOpenAddMemberModal} openAddMemberModal={openAddMemberModal} selectedMember={selectedMember} setSelectedMember={setSelectedMember} setTeamsData={setTeamsData} teamsData={teamsData} />}
    </Layout>
  )
}
