...
const Index = () => {
  ...
  if(openAddProduct) {
    return <AddProduct setOpenAddProduct={setOpenAddProduct} selectedProduct={selectedProduct} setSelectedProduct={setSelectedProduct} type={'DC - Primary Antibody Direct Conjugate'} />
  }
