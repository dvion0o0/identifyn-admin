...
import { HeaderWrapper, ContentWrapper, DyeInformation, ProductInformation, PriceInformation, ProductFormulation, ImageInformation } from './style'
    ...
    <Layout>
      ...
      <ContentWrapper>
        ...
        <ProductInformation>
          ...
          <div className="content" style={{ gridTemplateColumns: '35% 15% 45%' }}>
            <div className="first-container">
